...
public class Main extends Application
{
    ...
    public static void main(String[] args) throws UnsupportedAudioFileException, IOException {
        ...
        try {
            ...
            PodcasterController.getPodcasterController().publishPodcast("How to have a healthy lifestyle",Genre.SOCIETY,"How to have a healthy lifestyle","file:src/main/resources/audios/Morteza Hossein/How to have a healthy lifestyle.MP3",new Image("file:src/main/resources/audios/Morteza Hossein/pic.jpg"));
            ...
            PodcasterController.getPodcasterController().publishPodcast("Real Happiness",Genre.INTERVIEW,"Real Happiness","file:src/main/resources/audios/Hossein Aura/Real happiness.MP3",extractAlbumArt("file:src/main/resources/audios/Hossein Aura/in.png"));
            PodcasterController.getPodcasterController().publishPodcast("Hope",Genre.SOCIETY,"Hope","file:src/main/resources/audios/Hossein Aura/Hope.MP3",extractAlbumArt("filesrc/main/resources/audios/Hossein Aura/in.png"));
            PodcasterController.getPodcasterController().logout();
