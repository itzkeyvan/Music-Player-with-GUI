...
public class Main extends Application
{
    ...
    public static void main(String[] args)
    {
        ...
        try {
            ...
            PodcasterController.getPodcasterController().publishPodcast("How to have a healthy lifestyle",Genre.SOCIETY,"How to have a healthy lifestyle","file:src/main/resources/audios/Morteza Hossein/How to have a healthy lifestyle.MP3",extractAlbumArt("file:src/main/resources/audios/Morteza Hossein/How to have a healthy lifestyle.MP3"));
            ...
            PodcasterController.getPodcasterController().publishPodcast("Real Happiness",Genre.INTERVIEW,"Real Happiness","file:src/main/resources/audios/Hossein Aura/Real happiness.MP3",extractAlbumArt("src/main/resources/audios/Hossein Aura/Real happiness.MP3"));
            PodcasterController.getPodcasterController().publishPodcast("Hope",Genre.SOCIETY,"Hope","file:src/main/resources/audios/Hossein Aura/Hope.MP3",extractAlbumArt("file:src/main/resources/audios/Hossein Aura/Hope.MP3"));
            PodcasterController.getPodcasterController().logout();
    ...
    public static Image extractAlbumArt(String filePath) {
        ...
        return new Image("src/main/resources/graphic/musicplayergraphicalprojectphase2/PngAndJpg/PlayBar/DefaultAudioCover.png");
    }
}