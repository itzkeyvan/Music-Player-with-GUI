...
public class Main extends Application
{
    ...
    public static void main(String[] args) throws UnsupportedAudioFileException, IOException {
        ...
        try {
            ...
            SingerController.getSingerController().signUp("EdSheeran", "edSheSeran231!", "Ed Sheeran", "edsheeran@gmail.com", "09123456780", dateFormat.parse("1991-02-17"), "Edward Christopher Sheeran is an English singer-songwriter.", ArtistType.SINGER,new Image("file:src/main/resources/audios/Ed Sheeran/pp.jpg"));
            ...
            PodcasterController.getPodcasterController().signUp("MortezaHossein", "MHAhlou12!", "MortezaHossein", "mortezahossein@gmail.com", "09121119999", dateFormat.parse("1967-08-11"), "I'm a spotify podcaster.", ArtistType.PODCASTER,new Image("file:src/main/resources/audios/Morteza Hossein/pp.png"));
