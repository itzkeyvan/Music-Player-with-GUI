...
public class PodcasterController extends ArtistController
{
    ...
    public String publishPodcast(String title, Date releaseDate,Genre genre, String caption, String URL, Image cover) throws Exception {
        ...
        Podcast podcast=new Podcast(title,podcaster.getFirstAndLastName(),releaseDate,genre,URL,cover,caption);
