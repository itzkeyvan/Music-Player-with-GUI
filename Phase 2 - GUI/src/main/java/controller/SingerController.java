...
public class SingerController extends ArtistController
{
    ...
    public String publishMusic(String title, Date releaseDate,Genre genre, String lyrics, String URL, Image cover, String albumID) throws Exception {
        for(Album album:singer.getAlbumsList())
        ...
        Music music=new Music(title,singer.getFirstAndLastName(),releaseDate,genre,URL,cover,lyrics);
        for(Album album:singer.getAlbumsList())
